...
include_once G5_ADMIN_PATH ."/status/gDracoCounter.php";
...
<div style="width:980px;">
    <div style="float:left; width:230px; padding-left:20px;""><?php include G5_ADMIN_PATH ."/status/today_status.php"; ?></div>
    <div style="float:left; width:375px; padding:0 15px 0 15px;"><?php include G5_ADMIN_PATH ."/status/visit_status.php"; ?></div>
    <div style="float:left; width:375px;"><?php include G5_ADMIN_PATH ."/status/member_status.php"; ?></div>
    <div style="clear:both; padding:0px 0 0 0px;"></div>
</div>

<div style="width:980px; padding:25px 0 0 20px;">
    <img src="./img/bul2.gif" align="absmiddle"> <b>총 회원 수 : <?php echo number_format($total_member); ?> 명</b> &nbsp; (오늘가입: <?php echo $member_cnt[0]; ?> 명 ,&nbsp; 이달가입 <?php echo number_format($member_cnt['month']); ?> 명)
...
<div id="div_visit" style="width:980px; padding-left:20px;">
    <table width="890">
        ...
        <tr>
            ...
            <td><img src="./img/graph.gif" height="9" width="<?php echo ceil($count_visit[$i]/$max_count_visit*$bar_width); ?>" /></td>
            <td class="m3stats_align_c"><?php echo $count_direct[$i]; ?></td>
            <td><img src="./img/graph.gif" height="9" width="<?php echo ceil($count_direct[$i]/$max_count_direct*$bar_width); ?>" /></td>
            <td class="m3stats_align_c"><?php echo $count_join[$i]; ?></td>
            <td><img src="./img/graph.gif" height="9" width="<?php echo ceil($count_join[$i]/$max_count_join*$bar_width); ?>" /></td>
            <td class="m3stats_align_c"><?php echo $count_login[$i]; ?></td>
            <td><img src="./img/graph.gif" height="9" width="<?php echo ceil($count_login[$i]/$max_count_login*$bar_width); ?>" /></td>
            <td class="m3stats_align_c"><?php echo $count_article[$i]; ?>/<?php echo $count_comment[$i]; ?></td>
            <td><img src="./img/graph.gif" height="9" width="<?php echo ceil($count_article[$i]/$max_count_article*$bar_width); ?>" /></td>
        </tr>
        <?php 
        } 
        ?>
...
<div id="div_m3sq" style="width:980px; padding:30px 0 0 20px;">
    ...
    <table id="m3tbl">
        ...
        <tr>
            ...
            <td><a href="<?php echo $PHP_SELF?>?site=<?php echo $engine?>"><img src="./img/<?php echo strtolower($engine)?>.jpg" /></a></td>
