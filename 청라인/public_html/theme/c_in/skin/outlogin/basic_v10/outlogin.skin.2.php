...
<section id="ol_after" class="ol">
    <header id="ol_after_hd">
        ...
        <strong><?php echo $nick ?>님 | ID: <?php echo $member['mb_id']?></strong>
    ...
    <ul id="ol_after_private" style='margin-bottom:0px;'>
        <li>
            <a href="<?php echo G5_BBS_URL ?>/memo.php" target="_blank" id="ol_after_memo" class="win_memo">
                 <span class="sound_only">안 읽은 </span>쪽지<br>
                <strong><i class="fa fa-envelope" aria-hidden="true"></i> <?php echo $memo_not_read ?></strong>
            </a>
        </li>
        <li>
