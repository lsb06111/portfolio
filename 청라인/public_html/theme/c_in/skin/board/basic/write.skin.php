...
<section id="bo_w">
    ...
    <div class="bo_w_link write_div">
        <label for="wr_10"><i class="fab fa-youtube"></i><span class="sound_only"> 유튜브영상</span></label>
        <input type="text" name="wr_10" value="<?php echo $write['wr_10']?>" class="frm_input full_input" size="50">
		<br />
		유뷰브 주소표시줄에 있는 주소를 넣어주세요.
    </div>
