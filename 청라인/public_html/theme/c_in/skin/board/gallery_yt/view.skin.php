...
<div class="row">
	...
	<article id="bo_v" style="width:<?php echo $width; ?>">
		...
		<section id="bo_v_info">
			...
			<span class="sound_only">댓글</span><strong><a href="#bo_vc"> <i class="fa fa-commenting" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?>건</a></strong>
		...
		<section class="contents">
			<iframe width="100%" height="400" src="https://www.youtube.com/embed/<?php echo $yt;?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		
		<div>
		<!-- 출처 --> <strong>유튜브출처 : <a href="<?php echo $view['wr_10'];?>" target="_blank"><?php echo $view['wr_10'];?></a></strong>
		</div>
		</section>
		<?}?>
		...
		<div id="bo_v_top">
			...
			<ul class="bo_v_left">
				...
				<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fa fa-trash" aria-hidden="true"></i> 삭제</a></li><?php } ?>
				...
				<?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" class="btn_admin btn" onclick="board_move(this.href); return false;"><i class="fa fa-arrows-alt" aria-hidden="true"></i> 이동</a></li><?php } ?>
